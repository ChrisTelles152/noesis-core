...
describe('Prerequisite Subgraph Mastery Enforcement (Phase 4)', () => {
  describe('getEffectiveMastery', () => {
    it('should return own mastery when no prerequisites', () => {
      const engine = createDeterministicEngine(createSkillGraph(createChainSkills()), {}, startTime);
      ...
      engine.processEvent(createDiagnosticEvent(ctx, 'learner-1', 'session-1', ['foundation'], [
    ...
    it('should return minimum of skill and prerequisites', () => {
      ...
      engine.processEvent(createDiagnosticEvent(ctx, 'learner-1', 'session-1',
