...
export interface SessionAction {
    /** Type of action */
    type: 'practice' | 'review' | 'diagnostic' | 'transfer_test' | 'prerequisite_probe' | 'rest' | 'concept_introduction' | 'application' | 'reflection';
 ...
 */
export type NoesisEvent = PracticeEvent | DiagnosticEvent | TransferTestEvent | SessionEvent | ImplicitCreditEvent | CognitiveStateEvent | StageCompletedEvent;
/**
