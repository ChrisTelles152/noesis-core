...
export function requireClock(clock) {
    if (typeof clock !== 'function') {
        throw new Error('Noesis: clock must be injected. Use createDeterministicEngine(...) for replay, ' +
 ...
 */
export function requireIdGenerator(idGenerator) {
    if (typeof idGenerator !== 'function') {
        throw new Error('Noesis: idGenerator must be injected. Use createDeterministicEngine(...) for replay, ' +
 ...
 */
export function createDeterministicIdGenerator(prefix = 'evt') {
    let counter = 0;
 ...
 */
export function createEventFactoryContext(clock, idGenerator) {
 ...
 */
export function createPracticeEvent(ctx, learnerId, sessionId, skillId, itemId, correct, responseTimeMs, options = {}) {
    return {
        id: ctx.idGenerator(),
        type: 'practice',
        learnerId,
 ...
 */
export function createDiagnosticEvent(ctx, learnerId, sessionId, skillsAssessed, results) {
    return {
        id: ctx.idGenerator(),
        type: 'diagnostic',
        learnerId,
 ...
 */
export function createTransferTestEvent(ctx, learnerId, sessionId, testId, skillId, transferType, score, passed) {
    return {
        id: ctx.idGenerator(),
        type: 'transfer_test',
        learnerId,
 ...
 */
export function createSessionStartEvent(ctx, learnerId, sessionId, config) {
    return {
        id: ctx.idGenerator(),
        type: 'session_start',
        learnerId,
 ...
 */
export function createSessionEndEvent(ctx, learnerId, sessionId, summary) {
    return {
        id: ctx.idGenerator(),
        type: 'session_end',
        learnerId,
 ...
 */
export function createCognitiveStateEvent(ctx, learnerId, sessionId, vector) {
    return {
        id: ctx.idGenerator(),
 ...
 */
export function createStageCompletedEvent(ctx, learnerId, sessionId, skillId, stage, options = {}) {
    return {
        id: ctx.idGenerator(),
 ...
 */
export function createImplicitCreditEvent(ctx, learnerId, sessionId, sourceSkillId, targetSkillId, creditFraction, nextReviewShiftMs) {
    return {
        id: ctx.idGenerator(),
